...
struct lp503x_config_s config_default =
{
  ...
  .enable_log_mode          = 0,
#endif
#if defined (CONFIG_LP503X_POWER_SAVE)
  .enable_power_save        = 1,
#else  
  .enable_power_save        = 0,
#endif
#if defined (CONFIG_LP503X_DITHER_MODE)
  .enable_pwm_dithering     = 1,
#else
  .enable_pwm_dithering     = 0,
#endif
#if defined (CONFIG_LP503X_MAX_CURRENT)
  .set_max_current_35ma     = 1,
#else
  .set_max_current_35ma     = 0,
#endif
#if defined(CONFIG_LP503X_GLOBAL_SHUTDOWN)
...
static int lp503x_i2c_write_reg(FAR struct lp503x_dev_s *priv,
