...
#error no definitions for ATSAMA5D3 XDMA at this time
...
#define XDMAC0_CH_AES_TX            26  /* AES      Transmit  */
#define XDMAC0_CH_AES_RX            27  /* AES      Receive   */
...
#define XDMAC1_CH_AES_TX            26  /* AES      Transmit  */
#define XDMAC1_CH_AES_RX            27  /* AES      Receive   */
#define XDMAC1_CH_TDES_TX           28  /* TDES     Transmit  */
#define XDMAC1_CH_TDES_RX           29  /* TDES     Receive   */
#define XDMAC1_CH_SHA_TX            30  /* SHA      Receive   */
